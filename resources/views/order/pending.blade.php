<div class="col-xl-12">
    <div class="ps-widget bgc-white bdrs4 p30 mb30 overflow-hidden position-relative">
      <div class="packages_table table-responsive">
        <table class="table-style3 table at-savesearch" id="PendingOrder">
          <thead class="t-head">
            <tr>
          ...
          <tbody class="t-body">
            ...
            <tr>
              ...
              <th class="" scope="row">
                <p class="mb-0 fz14 list-inline-item mb5-sm pe-1">
                    <i class="flaticon-30-days fz16 vam text-thm2 me-1 "></i> 
                     {{ $order->created_at->addDays($order->rel_to_proposal->delivery_time)->format('M d y') }}
                  </p> 
              </th>
              ...
              <td class="vam">
                ...
                <div class="d-flex">
                  ...
                  <form action="{{ route('order.cancel', $order->id) }}" method="post">
                    @csrf
                    @method('POST')
                    <button type="submit" class="ud-btn ms-3" style="padding: 1px 8px; font-size: 12px; border: 2px solid black; background:#fcf9f0ce;">Cancel</button>
                  </form>
