               ...
               <div class="row">
                <div class="col-xl-12">
                  ...
                  <div class="ps-widget bgc-white bdrs12 p30 mb30 overflow-hidden position-relative">
                    ...
                    <div class="col-md-12">
                        <div class="text-start">
                          <a class="ud-btn btn-thm" href="{{ route('service.galleries.update',  ['id' => $id]) }}">Next<i class="fal fa-arrow-right-long"></i></a>
                        </div>
                      </div>
                  </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="ps-widget bgc-white bdrs4 p30  overflow-hidden position-relative">
                    <div class="col-xl">
                        <form class="form-style1" method="post" action="{{ route('update.save.faq', ['id' => $id]) }}">
