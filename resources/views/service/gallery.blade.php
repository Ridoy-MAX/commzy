                        ...
                        <div class="gallery-item me-3 bdrs4 overflow-hidden position-relative">
                          ...
                          <div class="del-edit">
                            <div class="d-flex justify-content-center">
                              ...
                              data-bs-placement="top" title="" data-bs-original-title="Edit" aria-label="Edit"><span class="flaticon-pencil"></span></a> --}}
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="ps-widget bgc-white bdrs4 p30  overflow-hidden position-relative">
                  <div class="col-xl">
                      <form class="form-style1" method="post" action="{{ route('save.gallery', ['serviceInformationId' => $serviceInformationId]) }}" enctype="multipart/form-data">
                          @csrf
                          <div class="row">
                              <div class="mb20">
