                          ...
                          @endphp
                            <tbody>
                              <tr>
                                ...
                                {{-- <img class="img-fluid logo-front" src="/public/images/media/1699245491Screenshot_12-removebg-preview.png" alt="logo"> --}}
                                </td>
                              </tr>
                            </tbody>
                          </table>
      ...
      >
        ...
        <div style="margin: 0px auto; max-width: 640px; background: #ffffff">
          <table
            ...
            cellpadding="0"
            cellspacing="0"
            style="font-size: 0px; width: 100%; background: #f094943a"
            align="center"
            border="0"
          >
            <tbody>
                    ...
                    >
                      <tbody>
                        <tr>
                          ...
                          >
                            ...
                            >
                              ...
                              <p>
                                You have received a new feedback on your service.
                              </p>
                        ...
                        <tr>
                          ...
                          <td>
                              <p
                              style="  font-family: Whitney, Helvetica Neue, Helvetica,
                              Arial, Lucida Grande, sans-serif;
                            font-weight: 600;
                            font-size: 16px;
                            color: #4f545c;
                            letter-spacing: 0.27px;"
                              ...
                              <p         style="  font-family: Whitney, Helvetica Neue, Helvetica,
                              Arial, Lucida Grande, sans-serif;
                            font-weight: 500;
                            font-size: 16px;
                            color: #4f545c;
                            letter-spacing: 0.27px;"> Regards,</p>
                              <p         style="  font-family: Whitney, Helvetica Neue, Helvetica,
                              Arial, Lucida Grande, sans-serif;
                            font-weight: 500;
                            font-size: 16px;
                            color: #4f545c;
                            letter-spacing: 0.27px;">Commzy.art</p>
                          </td>
